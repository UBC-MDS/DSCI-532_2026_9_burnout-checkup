...
transparency. All contributions in the form of code, documentation, design
...
Examples: 
- `feature/risk-indicator-card`
- `fix/filter-bug`
- `docs/readme-update`
- `test/eda-notebook-check`
...
- Include steps to reproduce (ifapplicable)
